...
#define OPTION_SWITCH_2HD	0x01
#define OPTION_SWITCH_2DD	0x02
#define OPTION_SWITCH_2D	0x04
#define DIPSWITCH_DEFAULT_LO	0
#define OPTION_SWITCH_DEFAULT	(OPTION_SWITCH_2HD | OPTION_SWITCH_2DD | OPTION_SWITCH_2D)
...
#define DIPSWITCH_DEFAULT_LO	DIPSWITCH_CMDSING
#define OPTION_SWITCH_DEFAULT	(/*OPTION_SWITCH_HMB20 | OPTION_SWITCH_GSX8800 | OPTION_SWITCH_PCG8100 | */0)
#else
