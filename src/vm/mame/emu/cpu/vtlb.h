...
#define VTLB_READ_ALLOWED           0x01        /* (1 << TR_READ) */
#define VTLB_WRITE_ALLOWED          0x02        /* (1 << TR_WRITE) */
#define VTLB_FETCH_ALLOWED          0x04        /* (1 << TR_FETCH) */
#define VTLB_FLAG_VALID             0x08
#define VTLB_USER_READ_ALLOWED      0x10        /* (1 << TR_UREAD) */
#define VTLB_USER_WRITE_ALLOWED     0x20        /* (1 << TR_UWRITE) */
#define VTLB_USER_FETCH_ALLOWED     0x40        /* (1 << TR_UFETCH) */
